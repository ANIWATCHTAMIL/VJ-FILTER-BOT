...
# Bot information
SESSION = environ.get('SESSION', 'Aniwatch')
API_ID = int(environ.get('API_ID', '27068498'))
API_HASH = environ.get('API_HASH', 'ebcf398a11320aa4776da819d1d919c0')
BOT_TOKEN = environ.get('BOT_TOKEN', "7671893217:AAEfJ5KLSabQqrDuG8gytqFa8DY-FjJJ_08")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002219124955').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002571214477')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Aniwatchfilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'aniwatchfilters')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Aniwatch_Discussion') # Support Chat Link Without https:// or @
